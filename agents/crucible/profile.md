...
## Collaboration Style
- Cipher 🔓 (Dev-Team Orchestrator) edits test code → auto-invokes Crucible 🔥 (Test Architect) per CLAUDE.md auto-run rule
- Crucible 🔥 (Test Architect) reads test files, applies pyramid rulebook, returns [PASS]/[FAIL]/[UNCERTAIN] report
- Cipher 🔓 (Dev-Team Orchestrator) routes fixes to implementing agent
