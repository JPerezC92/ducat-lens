...
4. **No external state mutation** — no external service writes, no DB writes, no git operations beyond a single commit
...
```
Status / Started / Subject / Layout: single-file / Context / Body / Critical files / Verification / Out of scope
```
